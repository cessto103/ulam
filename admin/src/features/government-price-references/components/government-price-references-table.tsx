...
import { regions, sources } from '../data/data'
import { type GovernmentPriceReference } from '../data/schema'
import { DataTableBulkActions } from './data-table-bulk-actions'
import { governmentPriceReferencesColumns as columns } from './government-price-references-columns'

type DataTableProps = {
  data: GovernmentPriceReference[]
  pageCount: number
  isLoading?: boolean
...
export function GovernmentPriceReferencesTable({
  data,
  pageCount,
  isLoading,
  search,
