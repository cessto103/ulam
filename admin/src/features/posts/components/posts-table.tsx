...
export function PostsTable({
  ...
  const {
    ...
    columnFilters: [
      { columnId: 'post_type', searchKey: 'post_type', type: 'array' },
      { columnId: 'is_sponsored', searchKey: 'is_sponsored', type: 'array' },
    ],
  })
        ...
        filters={[
          {
            columnId: 'post_type',
            title: 'Type',
            options: postTypes.map((type) => ({ ...type })),
          },
          {
            columnId: 'is_sponsored',
            title: 'Sponsored',
            options: [{ label: 'Sponsored', value: 'sponsored' }],
          },
        ]}
      />
