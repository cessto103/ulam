...
class RecipeController extends Controller
{
    ...
    private function rules(bool $sometimes = false): array
    {
        ...
        return [
            ...
            // budget_400plus is a legacy tag from an older tier scheme -- kept
            // valid here so existing recipes that still carry it can be saved
            // without being forced to change tiers, even though nothing
            // offers it as a choice for new recipes anymore.
            'budget_tag' => [$req, 'in:budget_100,budget_200,budget_400,budget_400plus,budget_600,budget_800,budget_1000,budget_1000plus'],
