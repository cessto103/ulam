    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('quantity')->required()->maxLength(255),
                Forms\Components\TextInput::make('unit')->required()->maxLength(30),
                Forms\Components\TextInput::make('estimated_price')->numeric()->prefix('₱'),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('estimated_price')->money('PHP'),
