...
<div class="wrapper">
    <div class="card">
        ...
        <div class="body">
            ...
            <p>Use this code to verify your secondary email address. It expires in 10 minutes.</p>
            <div class="code">{{ $code }}</div>
            <p style="font-size:13px; color:#B0A18C;">If you didn't request this, you can safely ignore this email.</p>
        </div>
        <div class="footer">
