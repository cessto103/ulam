...
<div class="wrapper">
    <div class="card">
        ...
        <div class="body">
            ...
            <p>Use this code in the uLam app to reset your password. It expires in 10 minutes.</p>
            <div class="code">{{ $code }}</div>
            <p style="font-size:13px; color:#B0A18C;">If you didn't ask to reset your password, you can safely ignore this email — your password stays the same.</p>
        </div>
        <div class="footer">
