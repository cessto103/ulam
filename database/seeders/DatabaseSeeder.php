...
class DatabaseSeeder extends Seeder
{
    ...
    /**
     * A starter set of Reward Tiers built on top of the Tasks seeded above.
     * Deliberately never gates on the 4 inert once-tasks (week-streak,
     * month-streak, budget-saver, super-saver) -- those have no action_type,
     * so they can never auto-complete, which would make any tier requiring
     * them permanently unearnable. Repeating (daily) tasks are safe to gate
     * on: the fulfillment check only asks "has this task ever been
     * completed," not "is it completed in the current period."
     */
    private function seedRewardTiers(): void
    {
